...
class _ProjectsState extends State<_Projects> {
  final ValueNotifier<int> _mobileNotifier = ValueNotifier(0);
      ...
      children: [
        CarouselSlider.builder(
            ...
            options: CarouselOptions(
              aspectRatio:
                  ResponsiveWidget.isLargeScreen(context) ? 6 / 4 : 1 / 1,
              enableInfiniteScroll: false,
              viewportFraction: 1.0,
              onPageChanged: (index, reason) => _mobileNotifier.value = index,
            )),
        const SizedBox(height: 20),
        ValueListenableBuilder(
            valueListenable: _mobileNotifier,
            builder: (context, value, child) {
              return AnimatedSmoothIndicator(
                  ...
                  effect: ExpandingDotsEffect(
                      ...
                      activeDotColor: themes.primaryColorDark,
                      dotWidth: 7,
                      dotHeight: 7));
            })
      ],
